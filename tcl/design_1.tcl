...
proc create_root_design { parentCell } {
  ...
  set rgb_leds_en [ create_bd_intf_port -mode Master -vlnv xilinx.com:interface:gpio_rtl:1.0 rgb_leds_en ]
...
\
  ...
  # Create instance: axi_gpio_rgb_leds, and set properties
  set axi_gpio_rgb_leds [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_gpio:2.0 axi_gpio_rgb_leds ]
  set_property -dict [list \
    CONFIG.C_ALL_OUTPUTS {1} \
  ...
  connect_bd_intf_net -intf_net axi_gpio_0_GPIO [get_bd_intf_ports rgb_leds_en] [get_bd_intf_pins axi_gpio_rgb_leds/GPIO]
  ...
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M01_AXI [get_bd_intf_pins ps7_0_axi_periph/M01_AXI] [get_bd_intf_pins axi_gpio_rgb_leds/S_AXI]
  ...
  [get_bd_pins axi_gpio_rgb_leds/s_axi_aclk] \
  ...
  [get_bd_pins axi_gpio_rgb_leds/s_axi_aresetn] \
  ...
  assign_bd_address -offset 0x41210000 -range 0x00010000 -with_name SEG_axi_gpio_0_Reg -target_address_space [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs axi_gpio_rgb_leds/S_AXI/Reg] -force
